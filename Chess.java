...
public class Chess {
    ...
    public static void main(String[] args) {
        ...
        Black.piece[12] = Black.elf1;
        Black.piece[13] = Black.elf2;
        ...
        White.piece[12] = White.elf1;
        White.piece[13] = White.elf2;
        ...
        White.elf1.menuLabel = " 13-Elefent-1  ";
        White.elf2.menuLabel = " 14-Elefent-2  ";
        ...
        Black.elf1.menuLabel = " 13-Elefent-1  ";
        Black.elf2.menuLabel = " 14-Elefent-2  ";
        ...
        board[7][2] = White.elf1.label;
        board[7][5] = White.elf2.label;
        ...
        board[0][2] = Black.elf1.label;
        board[0][5] = Black.elf2.label;
        ...
        while (!White.king.isDead && !Black.king.isDead && !isDraw) {
            ...
            if (!isWhitePlayable() && whiteCheckMate) {
                System.out.println();
                System.out.println("CHECKMATE!! White king is DEAD!! | Black Player is the WINNER!!");
            ...
            while (!whiteDone) {
                ...
                if (White.king.isPlayed == false && White.castle2.isPlayed == false && White.castle2.isDead == false
                        && whiteCheckMate == false && Piece.isEmpty(7, 6) && whiteCheckMateIndexes[7][6] != true
                        && Piece.isEmpty(7, 5)) {
                    System.out.print(" 17-Protect the King by Castle2");
                }
                if (White.king.isPlayed == false && White.castle1.isPlayed == false && White.castle1.isDead == false
                        && whiteCheckMate == false && Piece.isEmpty(7, 1) && whiteCheckMateIndexes[7][1] != true
                        && Piece.isEmpty(7, 2)
                        && Piece.isEmpty(7, 3)) {
                ...
                if (selection >= 1 && selection <= 16) {
                    ...
                    if (White.king.isPlayed == false && White.castle2.isPlayed == false
                            && White.castle2.isDead == false && whiteCheckMate == false
                            && Piece.isEmpty(7, 6) && Piece.isEmpty(7, 5)) {
                    ...
                    if (White.king.isPlayed == false && White.castle1.isPlayed == false
                            && White.castle1.isDead == false && whiteCheckMate == false
                            && Piece.isEmpty(7, 1) && Piece.isEmpty(7, 2)
                            && Piece.isEmpty(7, 3)) {
            ...
            if (isBlackPlayable() == false && blackCheckMate) {
                System.out.println();
                System.out.println("CHECKMATE!! Black king is DEAD!! | White Player is the WINNER!!");
                System.out.println();
            ...
            while (blackDone == false) {
                ...
                if (Black.king.isPlayed == false && Black.castle2.isPlayed == false && Black.castle2.isDead == false
                        && blackCheckMate == false && Piece.isEmpty(0, 6) && blackCheckMateIndexes[0][6] != true
                        && Piece.isEmpty(0, 5)) {
                    System.out.print(" 17-Protect the King by Castle2");
                }
                if (Black.king.isPlayed == false && Black.castle1.isPlayed == false && Black.castle1.isDead == false
                        && blackCheckMate == false && Piece.isEmpty(0, 1) && blackCheckMateIndexes[0][1] != true
                        && Piece.isEmpty(0, 2)
                        && Piece.isEmpty(0, 3)) {
                    System.out.print(" 18-Protect the King by Castle1");
                }
                ...
                if (selection >= 1 && selection <= 16) {
                    ...
                    if (Black.king.isPlayed == false && Black.castle2.isPlayed == false
                            && Black.castle2.isDead == false && blackCheckMate == false
                            && Piece.isEmpty(0, 6) && Piece.isEmpty(0, 5)) {
                    ...
                    if (Black.king.isPlayed == false && Black.castle1.isPlayed == false
                            && Black.castle1.isDead == false && blackCheckMate == false
                            && Piece.isEmpty(0, 1) && Piece.isEmpty(0, 2)
                            && Piece.isEmpty(0, 3)) {
    ...
    final static void printWhiteBoard() {
        System.out.println(
                "         1         2         3         4         5         6         7        8      ");
        System.out.println(
                "     ------------------------------------------------------------------------------");
    ...
    final static void printBlackBoard() {
        System.out.println(
                "         1         2         3         4         5         6         7        8      ");
        System.out.println(
                "     ------------------------------------------------------------------------------");
...
class Piece {
    ...
    void setPosibleMoves() {
        if (pieceType == "king") {
            if ((((positionX + 1) <= 7 && (positionY + 1) <= 7 && isEmpty((positionX + 1), (positionY + 1))))
                    || (((positionX + 1) <= 7 && (positionY + 1) <= 7
                            && isKillable((positionX + 1), (positionY + 1))))) {
                posibleMoves[positionX + 1][positionY + 1] = true;
            }
            if ((((positionX + 1) <= 7 && (positionY - 1) >= 0 && isEmpty((positionX + 1), (positionY - 1))))
                    || (((positionX + 1) <= 7 && (positionY - 1) >= 0
                            && isKillable((positionX + 1), (positionY - 1))))) {
                posibleMoves[positionX + 1][positionY - 1] = true;
            }
            if ((((positionX - 1) >= 0 && (positionY + 1) <= 7 && isEmpty((positionX - 1), (positionY + 1))))
                    || (((positionX - 1) >= 0 && (positionY + 1) <= 7
                            && isKillable((positionX - 1), (positionY + 1))))) {
                posibleMoves[positionX - 1][positionY + 1] = true;
            }
            if ((((positionX - 1) >= 0 && (positionY - 1) >= 0 && isEmpty((positionX - 1), (positionY - 1))))
        ...
        if (pieceType == "horse") {
            if (((positionX + 2) <= 7 && (positionY + 1) <= 7 && isEmpty((positionX + 2), (positionY + 1)))
                    || ((positionX + 2) <= 7 && (positionY + 1) <= 7
                            && isKillable((positionX + 2), (positionY + 1)))) {
                posibleMoves[positionX + 2][positionY + 1] = true;
            }
            if (((positionX + 2) <= 7 && (positionY - 1) >= 0 && isEmpty((positionX + 2), (positionY - 1)))
                    || ((positionX + 2) <= 7 && (positionY - 1) >= 0
                            && isKillable((positionX + 2), (positionY - 1)))) {
                posibleMoves[positionX + 2][positionY - 1] = true;
            }
            if (((positionX - 2) >= 0 && (positionY + 1) <= 7 && isEmpty((positionX - 2), (positionY + 1)))
                    || ((positionX - 2) >= 0 && (positionY + 1) <= 7
                            && isKillable((positionX - 2), (positionY + 1)))) {
                posibleMoves[positionX - 2][positionY + 1] = true;
            }
            if (((positionX - 2) >= 0 && (positionY - 1) >= 0 && isEmpty((positionX - 2), (positionY - 1)))
                    || ((positionX - 2) >= 0 && (positionY - 1) >= 0
                            && isKillable((positionX - 2), (positionY - 1)))) {
                posibleMoves[positionX - 2][positionY - 1] = true;
            }
            if (((positionX + 1) <= 7 && (positionY + 2) <= 7 && isEmpty((positionX + 1), (positionY + 2)))
                    || ((positionX + 1) <= 7 && (positionY + 2) <= 7
                            && isKillable((positionX + 1), (positionY + 2)))) {
                posibleMoves[positionX + 1][positionY + 2] = true;
            }
            if (((positionX - 1) >= 0 && (positionY + 2) <= 7 && isEmpty((positionX - 1), (positionY + 2)))
                    || ((positionX - 1) >= 0 && (positionY + 2) <= 7
                            && isKillable((positionX - 1), (positionY + 2)))) {
                posibleMoves[positionX - 1][positionY + 2] = true;
            }
            if (((positionX + 1) <= 7 && (positionY - 2) >= 0 && isEmpty((positionX + 1), (positionY - 2)))
                    || ((positionX + 1) <= 7 && (positionY - 2) >= 0
                            && isKillable((positionX + 1), (positionY - 2)))) {
                posibleMoves[positionX + 1][positionY - 2] = true;
            }
            if (((positionX - 1) >= 0 && (positionY - 2) >= 0 && isEmpty((positionX - 1), (positionY - 2)))
        ...
        if (pieceType == "castle") {
            ...
            for (int i = positionX; i < 7; i++) {
                ...
                if (isKillable(positionX + j, positionY) == false && isEmpty(positionX + j, positionY) == false) {
                    break;
                }
                j++;
            }
            ...
            for (int i = positionY; i < 7; i++) {
                ...
                if (isKillable(positionX, positionY + j) == false && isEmpty(positionX, positionY + j) == false) {
                    break;
                }
                j++;
            }
        ...
        if (pieceType == "queen") {
            ...
            for (int i = positionX; i < 7; i++) {
                ...
                if (isKillable(positionX + k, positionY) == false && isEmpty(positionX + k, positionY) == false) {
                    break;
                }
                k++;
            }
            ...
            for (int i = positionY; i < 7; i++) {
                ...
                if (isKillable(positionX, positionY + k) == false && isEmpty(positionX, positionY + k) == false) {
                    break;
                }
                k++;
            }
    ...
    Piece(int positionX, int positionY, boolean isDead, String label, String partType, String color) {
        this.positionX = positionX;
        this.label = label;
        this.positionY = positionY;
        this.isDead = isDead;
...
class White extends Piece {
    ...
    static White solider1 = new White(6, 0, false, " w-sol-1 ", "solider", "white");
    static White solider2 = new White(6, 1, false, " w-sol-2 ", "solider", "white");
    static White solider3 = new White(6, 2, false, " w-sol-3 ", "solider", "white");
    static White solider4 = new White(6, 3, false, " w-sol-4 ", "solider", "white");
    static White solider5 = new White(6, 4, false, " w-sol-5 ", "solider", "white");
    static White solider6 = new White(6, 5, false, " w-sol-6 ", "solider", "white");
    static White solider7 = new White(6, 6, false, " w-sol-7 ", "solider", "white");
    static White solider8 = new White(6, 7, false, " w-sol-8 ", "solider", "white");
    ...
    static White elf1 = new White(7, 2, false, " w-elf-1 ", "elefent", "white");
    static White elf2 = new White(7, 5, false, " w-elf-2 ", "elefent", "white");
        ...
        if (isTransformed == false && positionX == 0) {
            ...
            if (positionX == 0) {
                ...
                while (done == false) {
                    ...
                    System.out.println("  1-Queen  2-Castle  3-Elefent   4-Horse  ");
                    System.out.println();
                    ...
                    if (selection == 1) {
                        ...
                        elefentCount++;
                        label = " w-elf-" + elefentCount + " ";
                        Chess.board[positionX][positionY] = label;
                        pieceType = "elefent";
                        done = true;
                        isTransformed = true;
                        menuLabel = soliderOrder + "-Elefent-" + elefentCount + "  ";
                    } else if (selection == 4) {
                        horseCount++;
    ...
    White(int positionX, int positionY, boolean isDead, String label, String pieceType, String color) {
...
class Black extends Piece {
    ...
    static Black solider1 = new Black(1, 0, false, " b-sol-1 ", "solider", "black");
    static Black solider2 = new Black(1, 1, false, " b-sol-2 ", "solider", "black");
    static Black solider3 = new Black(1, 2, false, " b-sol-3 ", "solider", "black");
    static Black solider4 = new Black(1, 3, false, " b-sol-4 ", "solider", "black");
    static Black solider5 = new Black(1, 4, false, " b-sol-5 ", "solider", "black");
    static Black solider6 = new Black(1, 5, false, " b-sol-6 ", "solider", "black");
    static Black solider7 = new Black(1, 6, false, " b-sol-7 ", "solider", "black");
    static Black solider8 = new Black(1, 7, false, " b-sol-8 ", "solider", "black");
    static Black horse1 = new Black(0, 1, false, " b-hrs-1 ", "horse", "black");
    static Black horse2 = new Black(0, 6, false, " b-hrs-2 ", "horse", "black");
    static Black elf1 = new Black(0, 2, false, " b-elf-1 ", "elefent", "black");
    static Black elf2 = new Black(0, 5, false, " b-elf-2 ", "elefent", "black");
    ...
    Black(int positionX, int positionY, boolean isDead, String label, String pieceType, String color) {
        super(positionX, positionY, isDead, label, pieceType, color);
    }
}